...
Entity::Entity() : f_pitchDegrees(90.0f), f_headingDegrees(0), b_walking(false), m_walkingDirection(WalkingDirection_Stop)
{
}
...
Vector Entity::direction()
{
	...
	q_pitch = QQuaternion::fromAxisAndAngle(1.0f, 0, 0, f_pitchDegrees);
	q_heading = QQuaternion::fromAxisAndAngle(0, 1.0f, 0, f_headingDegrees);
